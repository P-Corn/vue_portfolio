<template>
    <TheSection class="section">
      <v-row>
        ...
        md="6"
        >
          <div class="header-text text-container">
            ...
            <div class="header-button-container">
              <v-btn color="secondary" class="header-text-button">Button</v-btn>
              <v-btn color="primary" class="header-text-button">Button</v-btn>
            </div>
          </div>
          </v-col>     
        <v-col
